...
class AutoCornerHandler {
    companion object {
        private const val LOG_TAG = "AutoCornerHandler"
        ...
        fun setCorners(context: Context, isEnabled: Boolean): Boolean {
            val roundedSize = 57 // in dip (maybe). currently 57 is for A30 in HD+
            val contentPadding = 0 // in dip (maybe). currently the developer couldn't found the right value for it. due to Android 11 removed this from secure setting.
